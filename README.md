...
<p align="center">
  <a href="https://www.youtube.com/watch?v=61OGiO5oSQo">
    <img src="https://img.youtube.com/vi/61OGiO5oSQo/maxresdefault.jpg" alt="Spacey3D Demo Video" style="width:100%; max-width:700px; border-radius:10px;">
  </a>
</p>
...
```bash
git clone [https://github.com/poytaytoy/Spacey3D.git](https://github.com/poytaytoy/Spacey3D.git)

```

From here there are too approaches. From the root directory, if you are on Linux or Mac, install java onto your system and run

```bash
java -jar spacey3d-0.0.1.jar

```

For window users, I have conveninetly placed `spacey3d.exe` to run it. Just click on it.
